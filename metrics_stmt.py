        ...
        try:
            ...
            for method in os.listdir(test_dir):
                ...
                for fname in tqdm(os.listdir(renders_dir), desc="Metric evaluation progress"):
                    ...
                    lpipss.append(lpips_fn(render_tensor, gt_tensor).detach())
                    image_names.append(fname)
            ...
            with open(scene_dir + f"/results_stmt_{scale}.json", 'w') as fp:
                json.dump(full_dict[scene_dir], fp, indent=True)
            with open(scene_dir + f"/per_view_{scale}.json", 'w') as fp:
