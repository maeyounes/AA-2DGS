...
class GaussianModel:
    ...
    def get_covariance(self, scaling_modifier = 1):
        return self.covariance_activation(self.get_xyz, self.get_scaling_with_3D_filter, scaling_modifier, self._rotation)
    ...
    def load_ply(self, path):
        ...
        print("Number of points loaded : ", self._xyz.shape[0])
